                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <h4>Payroll & Overtime Settings</h4>
                                <div class="form-row mb-2">
                                    <div class="col-md-3">
                                ...
                                <h4>Calculation & Deduction Options</h4>
                                <div class="form-row mb-2">
                                    <div class="col-md-4">
                                ...
                                <h4>Weekend Overtime Settings</h4>
