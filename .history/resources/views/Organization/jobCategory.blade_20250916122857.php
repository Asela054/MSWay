    ...
    $('#dataTable').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    var buttons = '';
                    buttons += '<button style="margin:2px;" name="edit" id="'+row.id+'" class="edit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>';
                    buttons += '<button style="margin:2px;" type="submit" name="delete" id="'+row.id+'" class="delete btn btn-outline-danger btn-sm"><i class="far fa-trash-alt"></i></button>';
