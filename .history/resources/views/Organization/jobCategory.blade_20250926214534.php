                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-2">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input is_sat_ot_type_as_act"
                                                    name="is_sat_ot_type_as_act" id="is_sat_ot_type_as_act_1" value="1"
                                                    checked>As Act
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input is_sat_ot_type_as_act"
                                                    name="is_sat_ot_type_as_act" id="is_sat_ot_type_as_act_0"
                                                    value="0">Custom
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input is_sat_ot_type_as_act"
                                                    name="is_sat_ot_type_as_act" id="is_sat_ot_type_as_act_2"
                                                    value="2">Saturday is a working date
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input"
                                                    name="custom_saturday_ot_type" id="custom_saturday_ot_type_1"
                                                    value="1" checked>1
                                            </label>
                                        </div>
                                        <!-- <div class="form-check-inline">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input"
                                                    name="custom_saturday_ot_type" id="custom_saturday_ot_type_2"
                                                    value="2">2
                                            </label>
                                        </div>
                                    </div>
