        ...
        columns: [{
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if(rowapproved_status == 0){
                        buttons += ' <button name="edit" id="'.$row->id.'" class="edit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>'; 
                    }

                    if(row->approved_status == 0){
                        buttons += ' <button name="approve" id="'.$row->id.'" class="approve btn btn-outline-success btn-sm mr-1"><i class="fas fa-level-up-alt"></i></button>';
                    }
