                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <h6>Payroll & Overtime Settings</h6>
                                <div class="form-row mb-2">
                                    <div class="col-md-3">
                                ...
                                <!-- Calculation & Deduction Options -->
                                <h6>Calculation & Deduction Options</h6>
                                <div class="form-row mb-2">
                                    <div class="col-md-4">
                                ...
                                <h6>Weekend Overtime Settings</h6>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col text-center">
                            <h6 class="font-weight-normal">Are you sure you want to remove this data?</h6>
                        </div>
                    </div>
                </div>
