...
// new employee separation routes
Route::post('addUserLogin',['uses' => 'UserController@usercreate', 'as' => 'addUserLogin']); 
Route::get('/contactDetails/{id}',['uses' => 'EmployeeContactController@showcontact', 'as' => 'contactDetails']);
Route::get('/viewEmergencyContacts/{id}',['uses' => 'EmployeeContactController@showcontact', 'as' => 'viewEmergencyContacts']);
Route::post('contactUpdate',['uses' => 'EmployeeContactController@editcontact', 'as' => 'contactUpdate']);
