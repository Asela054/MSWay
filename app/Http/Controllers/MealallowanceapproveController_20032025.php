...
class MealallowanceapproveController extends Controller
{
    public function index(){
        ...
        return view('Mealandattendanceapprove.mealallowance', compact('companies','departments'));
    }
    ...
    public function mealalowance(Request $request){
        ...
        foreach ($query as $row) {
                ...
                if ($allowance) {
                    $remunerationid = $allowance->remuneration_id;
            ...
            if( $totalamount != 0){
                ...
                if($allowance){
                    ...
                    if($allowancetype == 1){
                        ...
                        $updatepayamount = $totalamount;
                    }else{
    
                        $updatepayamount = $monthlyremain;
                    }
                    ...
                    ->update([
                        'payment_amount' => $updatepayamount,
                        'updated_by' => Auth::id(),
                        'updated_at' => $current_date_time
                    ]);
                        ...
                        if($allowancetype == 1){
                            ...
                            $insertepayamount = $totalamount;
                        }else{
        
                            $insertepayamount = $monthlyremain;
                        }
                        ...
                        $termpayment->payment_amount = $insertepayamount;
