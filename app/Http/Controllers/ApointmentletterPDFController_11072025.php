...
class ApointmentletterPDFController extends Controller
{
    ...
    public function printdata(Request $request)
    {
                        ...
                        <div class="container">
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="section-content">
                                    {{ company_name }} is pleased to offer you the position of {{ job_title }} with effect 
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="section-content">
                                    ...
                                    will contribute eight (8%) percent of your Gross Monthly Salary to this Fund and the Company will 
                                    make a contribution of twelve (12%) percent of your Basic Monthly Salary to the credit of the 
                                    Company\'s account in this Fund. Furthermore, the Company will contribute three (3%) percent of your 
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="indent">
                                    <table>
                                        <tr><td><strong>Commencement of service between –</strong></td><td></td></tr>
                                        <tr><td>1<sup>st</sup> January and 31<sup>st</sup> March</td><td>- 14 days</td></tr>
                                        <tr><td>1<sup>st</sup> April and 30<sup>th</sup> June</td><td>- 10 days</td></tr>
                                        <tr><td>1<sup>st</sup> July and 30<sup>th</sup> September</td><td>- 07 days</td></tr>
                                        <tr><td>1<sup>st</sup> October and 31<sup>st</sup> December</td><td>- 04 days</td></tr>
                                    </table>
                                </div>
                                <div class="subsection">
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="subsection">
                                    ...
                                    <div class="indent">
                                        ...
                                        from properly performing your duties owing to ill health or accident.<br><br>
                                        b) Terminate your employment should it deem it necessary to do so as a consequence of 
                                        the re-organization of the Company.<br><br>
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="section-content">
                                    ...
                                    equipments, computers, books and records of having a connection with the Company\'s business, and 
                                    shall return all other property belonging to the Company, and it being distinctly understood that all such 
                                    lists, books, records, and the other documents, are the property of the Company.
                                </div>
                            </div>
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="subsection">
                                    ...
                                    or oral between the partners concerning such subject matter, and may be modified only by a 
                            ...
                            <div class="numbered-section">
                                ...
                                <div class="subsection">
                                    ...
                                    duties hereunder and shall in all respects obey and conform to the Company\'s order and 
        ...
        if ($data->isNotEmpty()) {
            ...
            $html = str_replace('{{ monthly_salary }}', number_format($appointment->compensation ?? 0), $html);
            ...
            $html = str_replace('{{ work_start_time }}', $appointment->on_time ?? '08:30 am', $html);
            $html = str_replace('{{ work_end_time }}', $appointment->off_time ?? '05:30 pm', $html);
            $html = str_replace('{{ saturday_start_time }}', '08:30 a.m.', $html);
            $html = str_replace('{{ saturday_end_time }}', '12:30 p.m.', $html);
