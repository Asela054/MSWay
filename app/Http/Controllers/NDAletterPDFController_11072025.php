...
class NDAletterPDFController extends Controller
{
    public function printdata(Request $request)
    {
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="intro-paragraph">
                                This Non-Confidentiality Agreement also knows as Non-Disclosure (the "Agreement") is made and entered into in Colombo by and between <strong>{{ company_name }}</strong> (hereafter known as "<strong>the Disclosing Party</strong>"), located at <strong>{{ company_address }}</strong> and <strong>{{ employee_name }}</strong> bearing National Identity card number <strong>{{ nic_number }}</strong> (hereinafter known as "<strong>the Receiving Party</strong>") at <strong>{{ employee_address }}</strong>
                            </div>
                            ...
                            <div class="signature-section">
                                ...
                                <div class="signature-block">
                                    ...
                                    <div class="signature-text">By: <span class="signature-line"></span></div>
        ...
        if ($data->isNotEmpty()) {
            ...
            $html = str_replace('{{ nic_number }}', $service->nic_number ?? '[NIC NUMBER]', $html);
