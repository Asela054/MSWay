...
class LeaveController extends Controller
{
    ...
    //     try {
    //     // Get employee details with company information
    //     $employee = DB::table('employees')
    //                 ->join('companies', 'employees.emp_company', '=', 'companies.id')
    //                 ->select('employees.*', 'companies.email as company_email')
    //                 ->where('employees.emp_id', $leave->emp_id)
    //                 ->first();

    //     if (!$employee) {
    //         \Log::error("Employee not found for leave application");
    //         return ['success' => false, 'message' => 'Employee not found'];
    //     }

    //     $coveringEmployee = DB::table('employees')->where('employees.emp_id', $leave->emp_covering)->first();

    //     $approvingPerson = DB::table('employees')->where('employees.emp_id', $leave->leave_approv_person)->first();

    //      $leaveType = DB::table('leave_types')->where('id', $leave->leave_type)->value('leave_type');

    //     // Email content
    //     $subject = "New Leave Application - " . $employee->emp_fullname;
        
    //     $body = "<h2>Leave Application Details</h2>";
    //     $body .= "<p><strong>Employee:</strong> " . $employee->emp_fullname . "</p>";
    //     $body .= "<p><strong>Employee ID:</strong> " . $employee->emp_id . "</p>";
    //     $body .= "<p><strong>Leave Type:</strong> " . $leaveType . "</p>";
    //     $body .= "<p><strong>From Date:</strong> " . $leave->leave_from . "</p>";
    //     $body .= "<p><strong>To Date:</strong> " . $leave->leave_to . "</p>";
    //     $body .= "<p><strong>Number of Days:</strong> " . $leave->no_of_days . "</p>";
    //     $body .= "<p><strong>Reason:</strong> " . $leave->reson . "</p>";
    //     $body .= "<p><strong>Covering Employee:</strong> " .$coveringEmployee->emp_fullname. "</p>";
    //     $body .= "<p><strong>Approving Person:</strong> " .$approvingPerson->emp_fullname  . "</p>";
    ...
    //     // Recipients
    //     $mail->setFrom($employee->emp_email, $employee->emp_fullname);
    //     $mail->addAddress($employee->company_email, 'HR Department');
    ...
    //     return ['success' => false, 'message' => 'Email sending failed', 'error' => $e->getMessage()];
    // }
