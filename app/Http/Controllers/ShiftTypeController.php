...
class ShiftTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $shifttype->workdays_count=$request->input('workdayscount') ?? 0;    
       $shifttype->minute_count=$request->input('minutecount') ?? 0;
    ...
    public function update(Request $request, ShiftType $shiftType)
    {
        ...
        $form_data = array(
            ...
            'workdays_count'        =>  $request->workdayscount ?? 0,            
            'minute_count'        =>  $request->minutecount ?? 0, 
