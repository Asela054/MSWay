...
class Auditattendace extends Model
{
    ...
    public function apply_audit_attedance($auto_empid,$emp_id, $month )
    {
        ...
        foreach ($period  as $curentdate) {
            ...
            if(empty($holiday) && empty($coverinfo)){
                ...
                if ($attendance->in_time || $attendance->out_time){
                    ...
                    if ($dayno>0 && $dayno<6 && $modifyedouttime->greaterThan(Carbon::parse('19:00'))) {
                    ...
                    } elseif($dayno==6 && $modifyedouttime->greaterThan(Carbon::parse('17:00'))){
