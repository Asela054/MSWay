...
$table = 'salary_incentives';
$primaryKey = 'id';

$columns = array(
    array('db' => 'salary_incentives.id', 'dt' => 'id', 'field' => 'id'),
    array('db' => 'salary_incentives.emp_id', 'dt' => 'emp_id', 'field' => 'emp_id'),
    array('db' => 'salary_incentives.month', 'dt' => 'month', 'field' => 'month'),
    array('db' => 'salary_incentives.paid_amount', 'dt' => 'paid_amount', 'field' => 'paid_amount'),
    array('db' => 'salary_incentives.paid_status', 'dt' => 'paid_status', 'field' => 'paid_status'),
    array('db' => 'salary_incentives.approve_status', 'dt' => 'approve_status', 'field' => 'approve_status'),
...
$extraWhere = "salary_incentives.status != '3'";
...
if (!empty($_POST['employee'])) {
    ...
    $extraWhere .= " AND salary_incentives.emp_id = '$employee'";
}
...
if (!empty($_POST['month'])) {
    $month = $_POST['month'];
    // Store month as first day of month (yyyy-mm-01) for comparison
    $monthDate = date('Y-m-01', strtotime($month . '-01'));
    $extraWhere .= " AND salary_incentives.month = '$monthDate'";
}

$joinQuery = "FROM salary_incentives
LEFT JOIN employees ON salary_incentives.emp_id = employees.emp_id AND employees.deleted = 0
