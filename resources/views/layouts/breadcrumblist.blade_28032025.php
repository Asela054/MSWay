...
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('attendenceleavedashboard')}}" class="breadcrumb-link breadcumpfont">Attendance & Leave</a></li>
  <li class="breadcrumb-item"><a href="#" class="breadcrumb-link breadcumpfont">Meal & Holiday Deduction Approval</a></li>
  <li class="breadcrumb-item"><a href="{{route('mealallowanceapproval')}}" class="breadcrumb-link breadcumpfont">Meal Allowance Approval</a></li>
</ol>
@elseif(request()->route()->getName() == 'holidaydeductionapproval')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('attendenceleavedashboard')}}" class="breadcrumb-link breadcumpfont">Attendance & Leave</a></li>
  <li class="breadcrumb-item"><a href="#" class="breadcrumb-link breadcumpfont">Meal & Holiday Deduction Approval</a></li>
  <li class="breadcrumb-item"><a href="{{route('holidaydeductionapproval')}}" class="breadcrumb-link breadcumpfont">Holiday Deduction Approval</a></li>
</ol>
...
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('auditattendancereport')}}" class="breadcrumb-link breadcumpfont">Audit Time In-Out Report</a></li>
</ol>
@elseif(request()->route()->getName() == 'auditotreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('auditotreport')}}" class="breadcrumb-link breadcumpfont">Audit Ot Report</a></li>
</ol>
