<div class="row nowrap" style="padding-top: 5px;padding-bottom: 5px;">
  ...
  <div class="dropdown">
    <a role="button" data-toggle="dropdown" class="btn navbtncolor" href="#" id="employeeletter">
        Employee Letters <span class="caret"></span></a>
        <ul class="dropdown-menu multi-level dropdownmenucolor" role="menu" aria-labelledby="dropdownMenu">
          <li><a class="dropdown-item" href="{{ route('letterType')}}" id="">Employee Letter Type</a></li>
          <li><a class="dropdown-item" href="{{ route('letterTemplate')}}">Employee Letter Template</a></li>
           <li><a class="dropdown-item" href="{{ route('issueLetter')}}">Employee Issued Letter</a></li>
        </ul>
  </div>
