                ...
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <button type="button" class="btn btn-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add GNS Division</button>
                            </div>
                        <div class="col-12">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add GNS Division</h5>
                            ...
                            <div class="col">
                                ...
                                <form method="post" id="formTitle" class="form-horizontal">
                                    ...
                                    <div class="form-row mb-1">
                                            <label class="small font-weight-bold text-dark">GNS Division*</label>
                                            <input type="text" name="GNSdivision" id="GNSdivision" class="form-control form-control-sm" required/>
                                    </div>
    ...
    <script>
        ...
        $('#employeemaster').addClass('navbtnactive');
           ...
           $('#dataTable').DataTable({
            ...
            ajax: {
                url: scripturl + '/gnsdivisionlist.php',
                type: "POST", 
            },
            "columns": [{
                    "data": "id",
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('gnsdivisioninsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('gnsdivisionupdate') }}";
                }
            ...
            $(document).on('click', '.edit', async function () {
                ...
                $.ajax({
                    url: '{!! route("gnsdivisionedit") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: id },
                    success: function (data) {
                        $('#GNSdivision').val(data.result.gns_division);
                        $('#hidden_id').val(id);
                        $('.modal-title').text('Edit GNS Division');
        ...
        async function deactiveRecord(id) {
            ...
            if (r == true) {
                window.location.href = "gnsdivisionstatus/" + id + "/2";
            }
        }
        ...
        async function activeRecord(id) {
            ...
            if (r == true) {
                window.location.href = "gnsdivisionstatus/" + id + "/1";
            }
        }
