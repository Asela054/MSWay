                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            @php
                                $profileImage = (!empty($employee->emp_pic_filename) && file_exists(public_path('public/images/' . $employee->emp_pic_filename)))
                                    ? url('/public/images/' . $employee->emp_pic_filename)
                                    : ($employee->emp_gender == 'Female' 
                                        ? url('/public/images/girl.png') 
                                        : url('/public/images/user-profile.png'));
                            @endphp


                            <img src="{{ $profileImage }}"  alt="Profile_Pic" 
                            style="width: 180px;height: 180px;border: 16px solid rgb(226 230 237);top: -0px;position: relative;" class="rounded-circle">
                        </div><br>
                        <div class="row">
    ...
    $(document).ready(function () {
       ...
       $('#btn-filter').click(function() {
            ...
            let approveby = $('#approveby');
             ...
             if (empid && emp_name_with_initial) {
                var option = new Option(emp_name_with_initial, empid, true, true);
                approveby.append(option).trigger('change');
            }
