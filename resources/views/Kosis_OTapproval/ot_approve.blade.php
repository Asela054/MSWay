                        ...
                        if(ot_data.length > 0) {
                            ot_data.forEach(function(key, data) {
                               ...
                               let row_style = '';
                                ...
                                ot_data_html += '<td><input type="number" class="form-control form-control-sm ot-hours" data-emp="'+obj.emp_id+'" name="hours[]" value="'+obj.hours+'" step="2"></td>';
                                ot_data_html += '<td><input type="number" class="form-control form-control-sm ot-double" data-emp="'+obj.emp_id+'" name="double_hours[]" value="'+obj.double_hours+'" step="2"></td>';
                                ot_data_html += '<td><input type="number" class="form-control form-control-sm ot-triple" data-emp="'+obj.emp_id+'" name="triple_hours[]" value="'+obj.triple_hours+'"  step="2"></td>';
                ...
                if (r == true) {
                    ...
                    cb.each(function (e1) {
                        ...
                        if (cb_obj.is(':checked')) {
                            ...
                            let to = to_cell.text();
                            let hours = hours_cell.find('input').val();
                            let double_hours = double_hours_cell.find('input').val();
                            let triple_hours = triple_hours_cell.find('input').val();
