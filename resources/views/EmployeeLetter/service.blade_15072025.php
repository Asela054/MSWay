...
@section('content')
    ...
    <main>
        ...
        <div class="container-fluid mt-4">
            <div class="card mb-2">
                <div class="card-body">
                    <form method="POST" action="{{ route('serviceletterinsert') }}"  class="form-horizontal">
                        {{ csrf_field() }}
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                url: '{!! route("serviceletterprintdata") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}',
            ...
            if (company !== '') {
                $.ajax({
                    url: '{!! route("servicelettergetdepartmentfilter", ["company_id" => "company_id"]) !!}'
