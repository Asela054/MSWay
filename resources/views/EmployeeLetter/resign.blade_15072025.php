...
@section('content')
    ...
    <main>
        ...
        <div class="container-fluid mt-4">
            <div class="card mb-2">
                <div class="card-body">
                    <form method="POST" action="{{ route('resignletterinsert') }}"  class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="form-row mb-1">
                            ...
                            <div class="col-md-3 ">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <input type="date" id="emp_join_date" name="emp_join_date" class="form-control form-control-sm" required >
                                </div>
                            </div>

                            <div class="col-md-3 ">
                                <label class="small font-weight-bold text-dark">Last Date</label>
                                <div class="input-group input-group-sm mb-3">
                                    <input type="date" id="last_date" name="last_date" class="form-control form-control-sm" placeholder="yyyy-mm-dd" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 ">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <input type="text" id="reason" name="reason" class="form-control form-control-sm" placeholder="If have">
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#emp_join_date').val(data.result.join_date);
                        $('#last_date').val(data.result.last_date);
            ...
            $.ajax({
                url: '{!! route("resignletterprintdata") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}',
            ...
            if (company !== '') {
                $.ajax({
                    url: '{!! route("resignlettergetdepartmentfilter", ["company_id" => "company_id"]) !!}'
            ...
            $('#employee_f').change(function () {
                ...
                if (employee_f !== '') {
                    $.ajax({
                        url: '{!! route("resignlettergetdetails", ["id" => "id"]) !!}'.replace('id', employee_f),
                        type: 'GET',
                        dataType: 'json',
                        success: function (data) {
                            // Job title handling
