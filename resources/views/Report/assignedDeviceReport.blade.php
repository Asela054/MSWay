        ...
        <div class="container-fluid">
            <div class="page-header-content py-3 px-2">
                <h1 class="page-header-title ">
                    ...
                    <span>Assigned Devices Report</span>
                </h1>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function load_dt(company,department){
        $('#emptable').DataTable({
                    ...
                    "buttons": [{
                            ...
                            title: 'Assigned Devices Reports',
            ...
            ajax: {
                  url: scripturl + "/rpt_assigned_devices.php",
                  type: "POST",
    ...
    //     doc.text('Assigned Devices Report', doc.internal.pageSize.getWidth() / 2, 15, { align: 'center' });
    ...
    //     if (employee !== 'All') {
    //         yPos += 5;
    //         doc.text(`Assigned Devices: ${employee}`, 15, yPos);
    //     }
    ...
    //     const headers = [[
    //         'EMPLOYEE ID', 'EMPLOYEE', 'DEVICE TYPE', 'MODEL NO', 'SERIAL NO', 'OTHER REF. NO', 'ASSIGN DATE', 'RETURN DATE', 'STATUS'
    //     ]];
    ...
    //             2: { cellWidth: 18, halign: 'left' },     // DEVICE TYPE
    //             3: { cellWidth: 20, halign: 'left' },     // MODEL NO
    //             4: { cellWidth: 18, halign: 'center' },   // SERIAL NO
    //             5: { cellWidth: 18, halign: 'center' },   // OTHER REF. NO
    //             6: { cellWidth: 18, halign: 'center' },   // ASSIGN DATE
    //             7: { cellWidth: 18, halign: 'center' },   // RETURN DATE
    ...
    //                 doc.setFontSize(9);
    //                 doc.setFont('helvetica', 'bold');
    //                 doc.text('Assigned Devices Report (Continued)', doc.internal.pageSize.getWidth() / 2, 18, { align: 'center' });
    //             }
    //         }
    //     });
