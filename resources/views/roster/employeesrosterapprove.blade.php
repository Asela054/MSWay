      ...
      <div class="container-fluid mt-2 p-0 p-2">
        <div class="card">
            <div class="card-body p-0 p-2">
                ...
                <form id="shiftForm">
                    <button type="submit" id="saveroster" class="btn btn-sm btn-primary float-right d-none">Approve Roster</button>
                </form><br><br>
...
$(document).ready(function() {
    ...
    $('#monthlyshifts_approve_view').addClass('navbtnactive');
