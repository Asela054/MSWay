                        ...
                        <div class="col">
                            ...
                            <form id="userlogform" method="post">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('name') ? ' has-error' : '' }} shipClass" id="name" name="name" placeholder="Type Employee Name">
                                    @if ($errors->has('name'))
                                    <span class="help-block">
                                ...
                                <input type="hidden" name="hidden_id" id="hidden_id" />
                                <input type="hidden" name="usercompany" id="usercompany" />
                            </form>
                        </div>
                    </div>
                </div>
            ...
            columns: [
                {
                    ...
                    "render": function(data, type, full) {
                        return '<a href="viewEmployee/'+full['id']+'">'+data+'</a>';
                    }
                },
                {
                    "targets": -1,
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (canEditEmployee && is_resigned == 0) {
                            buttons += '<button style="margin:1px;" data-toggle="tooltip" data-placement="bottom" title="Add Employee User Login Details" class="btn btn-outline-secondary btn-sm adduserlog" id="' + row.emp_id + '" name="' + row.emp_name_with_initial + '" company="' + row.emp_company + '"><i class="fas fa-user"></i></button>';
                        }
