                        ...
                        <div class="form-row mb-1">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="opt_rpt_a" name="opt_rpt" value="1" class="custom-control-input">
                                    <label class="custom-control-label small" for="opt_rpt_a">EPF & ETF</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="opt_rpt_b" name="opt_rpt" value="2" class="custom-control-input">
                                    <label class="custom-control-label small" for="opt_rpt_b">EPF Only</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="opt_rpt_c" name="opt_rpt" value="3" class="custom-control-input">
