                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="card border p-3">
                            <h5 class="title-style mb-0"><span>FINGER MARK & ASSIGNED MACHINE INFORMATION</span></h5>
                            <div id="machinechart-container" style="max-height:480px;overflow-y:auto;overflow-x:auto;width:100%;">
...
$(document).ready( function () {
    ...
    function loadMachineChart() {
        $.ajax({
            url: '{{ route("opma_machinechart") }}',
            type: 'GET',
            success: function(response) {
                $('#machinechart-container').html(response);
            },
            error: function() {
                $('#machinechart-container').html('<p class="text-danger text-center">Failed to load machine chart.</p>');
            }
        });
    }
